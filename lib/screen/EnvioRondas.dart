      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            provider.currentindexsegment == 0
                ? SizedBox(
                    width: MediaQuery.of(context).size.width,
                    height: 500,
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String observacion =
                            provider.listaguards[index].observacion!;
                        String punto = provider.listaguards[index].punto!;
                        String fecha = provider.listaguards[index].date! +
                            " " +
                            provider.listaguards[index].time!;
                        String namefoto = provider.listaguards[index].date!
                                .replaceAll("-", "") +
                            provider.listaguards[index].time!
                                .replaceAll(":", "");
                                          ...
                                          onPressed: () async {
                                            showDialog<void>(
                                              ...
                                              builder: (BuildContext context) {
                                                return AlertDialog(
                                                  title: const Text(
                                                    'Eliminar registro de ronda',
                                                    style: TextStyle(
                                                        fontFamily: 'PoppinsB'),
                                                  ),
                                                  content: const Text(
                                                      'Desea eliminar registro de ronda',
                                                      style: TextStyle(
                                                          fontFamily:
                                                              'PoppinsL')),
                                                  actions: <Widget>[
                                          ...
                                          onPressed: () async {
                                            showDialog<void>(
                                              ...
                                              builder: (BuildContext context) {
                                                return AlertDialog(
                                                  title: const Text(
                                                    'Actualizar registro de ronda',
                                                    style: TextStyle(
                                                        fontFamily: 'PoppinsB'),
                                                  ),
                                                  content: Column(children: [
                                                    const Text(
                                                        'Desea actualizar registro de ronda',
                                                        style: TextStyle(
                                                            fontFamily:
                                                                'PoppinsL')),
                                                    TextFormField(
                                  ...
                                  child: MaterialButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      http.Response respuesta =
                                          await RondaProvider()
                                              .uploadImage(path!, namefoto);
                                      http.Response respuesta2 =
                                          await RondaProvider().sync(
                                              provider.listaguards[index]);
                                      if (respuesta2.statusCode == 200) {
                                        Navigator.of(context).pop();
                                        final res = await DBProvider.db
                                            .updatesync(provider
                                                .listaguards[index].id!);
                ...
                : SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String observacion =
                            provider.listaguardsends[index].observacion!;
                        String punto = provider.listaguardsends[index].punto!;
                        String fecha = provider.listaguardsends[index].date! +
                            " " +
                            provider.listaguardsends[index].time!;
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                        ...
                                        child: Text(
                                          ...
                                          maxLines: 20,
                                          style:
                                              TextStyle(fontFamily: 'PoppinsL'),
                                        )),
                                    Text(
                                      'Fecha:$fecha',
                                      style: TextStyle(
                                          fontSize: 15, fontFamily: 'PoppinsL'),
                                    ),
                                  ],
                                ),
                              ],
                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: provider.isloading
                            ? null
                            : () async {
                                final listadisponibles =
                                    await DBProvider.db.getguarddisponible();
                                final conectado = await InternetConnection()
                                    .hasInternetAccess;
                                    ...
                                    builder: (_) => const Center(
                                      child: CupertinoAlertDialog(
                                        content: Row(children: [
                                          Text('Sin conexión para enviar datos')
                                        ]),
                                      ),
                                    ),
                                  );
                                ...
                                int total = listadisponibles.length;
                                int enviados = 0;
                                double progreso = 0.0;

                                // Referencias para actualizar/cerrar el diálogo
                                StateSetter? setDialogState;
                                BuildContext? dialogCtx;

                                // Abre el diálogo y guarda setState del StatefulBuilder
                                showDialog(
                                  context: context,
                                      ...
                                      builder: (ctx, setState) {
                                        ...
                                        return AlertDialog(
                                          ...
                                          content: Column(
                                            ...
                                            children: [
                                              // Si total==0 mostramos indeterminado (animado)
                                              ...
                                              Text(
                                                total == 0
                                                    ? 'Preparando…'
                                                    : '${(progreso * 100).toStringAsFixed(0)}% completado ($enviados/$total)',
                                              ),
                                            ],
                                          ),
                                        );
                                ...
                                try {
                                  if (total == 0) {
                                    // Nada que enviar: cierra el diálogo y termina
                                    if (dialogCtx != null) {
                                  ...
                                  // Envío secuencial con progreso
                                  for (final element in listadisponibles) {
                                    final nombrefoto =
                                        element.date!.replaceAll("-", "") +
                                            element.time!.replaceAll(":", "");

                                    final respImg = await RondaProvider()
                                        .uploadImage(
                                            element.idimage!, nombrefoto);
                                    final respSync =
                                        await RondaProvider().sync(element);

                                    if (respSync.statusCode == 200) {
                                      await DBProvider.db
                                          .updatesync(element.id!);
                                    }
