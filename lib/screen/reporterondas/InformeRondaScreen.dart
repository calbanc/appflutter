  ...
  List<GridColumn>getColumns(){
    return <GridColumn>[
      GridColumn(
          ...
          label: Center(child: Text('Evidencia',style: TextStyle(fontWeight: FontWeight.bold),))
      ),
      GridColumn(
          columnName: 'Hora',
          autoFitPadding: EdgeInsets.all(10.0),
          label: Center(child: Text('Hora',style: TextStyle(fontWeight: FontWeight.bold),))),

      GridColumn(
          autoFitPadding: EdgeInsets.all(10.0),
          columnName: 'Zona',
          label: Center(child: Text('Zona',style: TextStyle(fontWeight: FontWeight.bold),))
      ),
      GridColumn(
          autoFitPadding: EdgeInsets.all(10.0),
          columnName: 'Punto de Control',
          label: Center(child: Text('Punto de Control',style: TextStyle(fontWeight: FontWeight.bold),))
      ),
      GridColumn(
          autoFitPadding: EdgeInsets.all(10.0),
          columnName: 'Observacion',
          label: Center(child: Text('Observacion',style: TextStyle(fontWeight: FontWeight.bold),))
      ),
      GridColumn(
          autoFitPadding: EdgeInsets.all(10.0),
          columnName: 'Tipo Guardia',
          label: Center(child: Text('Tipo Guardia',style: TextStyle(fontWeight: FontWeight.bold),))
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title:const  Text('Informe de ronda',style: TextStyle(color: Colors.white),),),
              ...
              child: SizedBox(
                ...
                child: MaterialButton(
                  ...
                  onPressed: ()async{
                    ...
                    http.Response response=await ReporteRondaProvider().serchbycompanyclient(datectrl.text, idclient);
                    setState(() {
                      cargando=false;
                    });
                  ...
                  child: cargando? CupertinoActivityIndicator() : Text('CONSULTAR',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),),
              ),
            ),
      ...
      SizedBox(
        ...
        child: ClipRRect(
          ...
          child:CachedNetworkImage(
            imageUrl:'https://cliente.seguridadsegser.com/assets/rondas/${row.getCells()[0].value.toString()}.png' ,
  ...
  void buildDataGridRow(){
    dataGridRow=listatotales.map<DataGridRow>((dataGridRow){
      return DataGridRow(cells: [
        ...
        DataGridCell(columnName: 'Punto de Control', value:   dataGridRow.puntocontrol),
        DataGridCell(columnName: 'Observacion', value:   dataGridRow.observation),
        DataGridCell(columnName: 'Tipo Guardia', value:   dataGridRow.typeguardia),
