...
class RegistrControl extends StatefulWidget {
  const RegistrControl({super.key});

  @override
  State<RegistrControl> createState() => _RegistrControlState();
}

class _RegistrControlState extends State<RegistrControl> {
  @override
                          ...
                          if (!snapshot.hasData) {
                            ...
                            return DropdownSearch<TipoGuard>(
                              ...
                              popupProps: const PopupProps.dialog(
                                  ...
                                  isFilterOnline: true),
                              items: lista!,
                              itemAsString: (TipoGuard u) => u.name!,
                  ...
                  child: Padding(
                    ...
                    child: CupertinoButton(
                      ...
                      onPressed: () async {
                        ...
                        provider.Observacion =
                            provider.observacionController.text;
                        Guard guardia = Guard(
                            iduser: iduser,
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Datos registrados correctamente localmente ',
                              style: TextStyle(color: Colors.white),
                            ),
                        ...
                        await Share.shareXFiles([XFile(provider.imagepath)],
                            text: provider.Observacion);
                        Navigator.of(context).pop();
                      },
                    ),
                  ),
